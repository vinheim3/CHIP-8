...
EMCC_PRELOADS=--preload-file roms/TEST --preload-file roms/SNAKE --preload-file roms/SOKOBAN1 --preload-file roms/PEPE --preload-file beep.wav --use-preload-plugins 
...
clean:
	rm chip8.js chip8.data chip8.wasm
